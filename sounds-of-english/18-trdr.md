...
`tr, dr` 和 `tʃ, dʒ` 不一样的地方在于，`tr, dr` 在发声之前嘴唇要有个缩小成圆形的动作，所以它们开头的音节，总是听起来夹带着一个 `w`，tree `/triː`/ 听起来好像是 `/tʃwiː/`<span class="speak-word-inline" data-audio-uk="/audios/tree-uk.mp3"></span><span class="speak-word-inline" data-audio-us="/audios/tree-us.mp3"></span>，dry `/draɪ/` 听起来好像是 `dʒwaɪ`<span class="speak-word-inline" data-audio-uk="/audios/dry-uk.mp3" data-audio-us="dry-us.mp3"></span>。
